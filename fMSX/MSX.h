...
#define MSX_MOUSE1    0x00000020 /* Mouse in socket #1       */
#define MSX_JOYMOUSE1 0x00000030 /* Mouse as joystick #1     */
#define MSX_NOJOY2    0x00000000 /* No joystick in socket #2 */
#define MSX_JOY2      0x00000040 /* Joystick in socket #2    */
#define MSX_MOUSE2    0x00000080 /* Mouse in socket #2       */
#define MSX_JOYMOUSE2 0x000000C0 /* Mouse as joystick #2     */
